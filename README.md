...
- `I`: cycle influence flow filter (`Focused`, `Incoming`, `Outgoing`, `All`)
- `O`: toggle edge color meaning (`Current Impact` vs `Rule Type`)
- `Z/X/P`: set map preview mode (`Current` / `Do Nothing` / `Selected Card`)
